...
<form method="post" action="/dasboard/posts/{{ $post->slug }}" enctype="multipart/form-data">
  @method('put')
    @csrf
    <div class="mb-3">
...
@enderror
    <div class="mb-3">
      ...
      <select class="form-select" selected name="category_id" >
      ...
      <div class="mb-3">
        <label for="image" class="form-label ">Ubah Image</label>
  ...
  <trix-editor input="body"></trix-editor>
    ...
    <script>
        ...
        tittle.addEventListener('change',function() {
            fetch('dasboard/posts/checkSlug?tittle=' + tittle.value)
